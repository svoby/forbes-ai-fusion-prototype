...
This project uses the **Unity Test Framework** (`com.unity.test-framework` in `Packages/manifest.json`). Automated tests live in assembly **Forbes.Tests.EditMode** (`Assets/Tests/EditMode/`).
...
**Fusion** network smoke tests, PlayMode component tests, and multi-client automation are **intentionally out of scope** for this harness. Planned fixtures are described in `docs/TEST_COVERAGE_PLAN.md`.
