...
namespace Forbes.Tests.EditMode {
  ...
  public class CombatFeedbackBannerVisibilityTests {
    ...
    [TestCase(CombatFeedbackReason.CastInterruptedByMovement,  false)]
    [TestCase(CombatFeedbackReason.CastInterruptedByJump,     false)]
    [TestCase(CombatFeedbackReason.CastInterruptedByNewSpell,  false)]
    [TestCase(CombatFeedbackReason.AlreadyCasting,             true)]
    [TestCase(CombatFeedbackReason.CastInterruptedManual,      true)]
